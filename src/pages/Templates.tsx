...
const templates: Template[] = [
  // ---------- ⭐ Flagship ----------
  { id: "allinone", name: "All-in-One Mega Bot", desc: "30+ commands: mod + economy + fun + utility + AI + music, all in one.", icon: Rocket, gradient: "from-fuchsia-500 via-purple-500 to-indigo-600", category: "⭐ Flagship", prompt: "Build a MASSIVE all-in-one Discord bot with 30+ commands spanning: full moderation (warn, mute, kick, ban, purge, lock, slowmode, modlog), full economy (balance, daily, work, gamble, shop, inventory, leaderboard, pay), fun (8ball, meme, joke, roll, coinflip, rps), utility (remind, weather, translate, poll, afk), AI chat + AI image, and music (play, pause, skip, queue). Include welcome messages, leveling with XP, autoroles, custom /help with pagination, and a settings /config command. Modern discord.js v14.16.3, ES modules, JSON persistence, all with permission checks and beautiful embeds." },
  { id: "hosting", name: "24/7 Hosting Ready", desc: "Keep-alive HTTP server + auto-restart, ready for Railway/Fly/Replit.", icon: Zap, gradient: "from-emerald-500 to-cyan-600", category: "⭐ Flagship", prompt: "Build a Discord bot with production hosting built-in: express keep-alive server on PORT env, /uptime and /status commands, PM2-ready ecosystem.config.cjs, Dockerfile, Procfile for Railway/Heroku, .github/workflows/deploy.yml, auto-reconnect on disconnect, error webhook to a Discord channel, health check endpoint /health. Include a basic ping + info + invite command as starter, plus a full README with deploy steps for Railway, Fly.io, Render, and Replit." },
  { id: "serverstats", name: "Server Stats Dashboard", desc: "Live voice-channel counters + web dashboard + analytics.", icon: LineChart, gradient: "from-blue-500 to-violet-600", category: "⭐ Flagship", prompt: "Server stats bot: voice channels that auto-update with member count / online / bots / boosts every 10min, /stats command with rich embed graphs, tracks daily joins/leaves to JSON, /growth shows 7-day chart via quickchart.io, /leaderboard most active users by message count." },
  { id: "dashboard-bot", name: "Web Dashboard Bot", desc: "Bot + Express dashboard for config via browser.", icon: Cpu, gradient: "from-orange-500 to-rose-500", category: "⭐ Flagship", prompt: "Discord bot with a bundled web dashboard: express + EJS at /dashboard, Discord OAuth2 login, per-guild settings page (prefix, welcome channel, autorole, log channel) saved to JSON, secure session cookies, plus a full set of commands that read those settings live." },

  // ---------- Moderation ----------
  { id: "mod-full", name: "Full Moderation Suite", desc: "Warn, mute, kick, ban, unban, purge, lock, unlock, slowmode with a modlog.", icon: Shield, gradient: "from-red-500 to-orange-500", category: "Moderation", prompt: "Build a complete moderation bot with warn, mute (timeout), unmute, kick, ban, unban, purge, lock, unlock, slowmode commands, plus a modlog channel that logs every action with embeds, a persistent case system with /case <id>, and /warnings <user>. Include permission checks and ephemeral replies." },
