...
export const TOOLS: Tool[] = [
  ...
  { id: "website-builder", name: "Website Builder", desc: "Build complete websites with AI in minutes.", credits: 499, rating: 4.9, icon: Globe, color: "from-blue-500/20 to-blue-500/5 text-blue-400 border-blue-500/30" },
