import { Code2, Image as ImageIcon, Globe, FileText, MessageSquare, FileSearch, Mail, Megaphone, Gamepad2 } from "lucide-react";
...
export const TOOLS: Tool[] = [
  ...
  { id: "3d-game-maker", name: "3D Game Maker AI", desc: "Design 3D game worlds, scenes, assets, scripts, and publish-ready game plans.", credits: 599, rating: 4.9, icon: Gamepad2, color: "from-violet-500/20 to-blue-500/5 text-violet-300 border-violet-500/30" },
